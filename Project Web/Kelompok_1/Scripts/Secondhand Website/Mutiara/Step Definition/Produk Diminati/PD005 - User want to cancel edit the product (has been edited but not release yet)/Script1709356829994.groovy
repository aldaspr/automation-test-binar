...
WebUI.callTestCase(findTestCase('Secondhand Website/Mutiara/Pages/Produk Diminati/Click back'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

WebUI.callTestCase(findTestCase('Secondhand Website/Mutiara/Pages/Produk Diminati/Verify confirmation text visible'), 
    [:], FailureHandling.STOP_ON_FAILURE)
