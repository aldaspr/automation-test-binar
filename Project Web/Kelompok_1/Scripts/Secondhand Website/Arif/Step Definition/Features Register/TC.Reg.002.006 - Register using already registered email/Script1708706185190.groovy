...
WebUI.callTestCase(findTestCase('Secondhand Website/Arif/Pages/Register/Input Email'), [('email') : GlobalVariable.G_Email], 
...
WebUI.callTestCase(findTestCase('Secondhand Website/Arif/Pages/Register/Verify Email Taken Warning'), [:], FailureHandling.STOP_ON_FAILURE)
