...
WebUI.callTestCase(findTestCase('Secondhand Website/Arif/Pages/Register/Input Email'), [('email') : 'asdafafaf'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Secondhand Website/Arif/Pages/Register/Read Error Wrong Format Email'), [:], FailureHandling.STOP_ON_FAILURE)
